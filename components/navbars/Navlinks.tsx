...
export function Navlinks({
  ...
  const desktopBase = `inline-block px-1 py-0.5 text-sm font-medium rounded-md
                       ${transitions} ${focusEffects} leading-none`;
  ...
  const menuBase = `inline-flex items-center justify-center whitespace-nowrap
                    rounded-full px-3 py-1.5 text-sm font-medium ${transitions} ${focusEffects}`;
  ...
  const menuMobileBase = `inline-flex items-center justify-center whitespace-nowrap
                          rounded-full px-4 py-2 text-base font-medium ${transitions} ${focusEffects}`;
