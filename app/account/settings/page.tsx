...
export default function SettingsPage() {
  ...
  return (
    <main className="w-full max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-8">
      ...
      {/* Card */}
      <section
        className={`grad-primary rounded-lg shadow-md p-5 md:p-6 grid grid-cols-1
                    md:grid-cols-[180px_1fr] gap-6 items-start`}
        aria-labelledby="settings-heading"
      >
        {/* avatar / mini-profile */}
        <div className="flex flex-col items-center gap-3">
          <div
            className={`w-36 h-36 rounded-full bg-white/80 border-orange-100
                        border flex items-center justify-center shadow`}
            aria-hidden="true"
          >
        ...
        <div>
          ...
          <div className="text-sm text-stone-600 mb-4">
            ...
            <p className="mt-2">
              We store only the information needed to provide this demo experience. No payment is processed.
            </p>
          </div>
