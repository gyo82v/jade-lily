    ...
    <div className="w-full">
      ...
      {cart.length === 0 ? (
        ...
        <>
          ...
          <div className="rounded-lg p-4 md:p-6 bg-gradient-to-br from-orange-100 to-orange-50 shadow-md flex flex-col md:flex-row md:items-center gap-4">
...
export default function AccountCartPage() {
  ...
  const subtotal = useMemo(() => {
    return cart.reduce((sum, it) => sum + (it.price || 0) * (it.qty || 1), 0);
  }, [cart]);
